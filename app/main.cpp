...
int main(int argc, char **argv)
{
    ...
    app.setApplicationName(QStringLiteral("tukwriter"));

    /**
     * Connect application with translation catalogs, Kate & KWrite share the same one
     */
    KLocalizedString::setApplicationDomain("tukwriter");

    /**
     * construct about data for TukWriter
     */
    KAboutData aboutData(QStringLiteral("tukwriter"),
                         i18n("TukWriter"),
                         QStringLiteral(KATE_VERSION),
                         i18n("TukWriter- Text Editor"),
